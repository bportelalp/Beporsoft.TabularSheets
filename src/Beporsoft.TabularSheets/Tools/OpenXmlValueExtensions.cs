...
namespace Beporsoft.TabularSheets.Tools
{
    ...
    internal static class OpenXmlValueExtensions
    {
        ...
        /// </summary>
        internal static HexBinaryValue ToHexBinaryOpenXml(this Color color)
        ...
        /// </summary>
        internal static UInt32Value ToUint32OpenXml(this int value) => new UInt32Value(Convert.ToUInt32(value));
